...
java -Xmx8g -jar /md01/nieyg/software/GenomeAnalysisTK_3.5-0.jar -R /md01/nieyg/ref/10X/refdata-cellranger-arc-mm10-2020-A-2.0.0/fasta/genome.fa  -T RealignerTargetCreator  -nt 32 -I atac_possorted_bam_rmdup.AddOrReplaceReadGroups.bam  -o atac_possorted_bam_rmdup.target.intervals

java -Xmx100g -jar /md01/nieyg/software/GenomeAnalysisTK_3.5-0.jar -R /md01/nieyg/ref/10X/refdata-cellranger-arc-mm10-2020-A-2.0.0/fasta/genome.fa  -T IndelRealigner -filterNoBases -maxReads 10000000  -I atac_possorted_bam_rmdup.AddOrReplaceReadGroups.bam -targetIntervals atac_possorted_bam_rmdup.target.intervals -o atac_possorted_bam_rmdup.realign.bam

# Step4: mpileup get file for snv calling

samtools mpileup  -l /md01/nieyg/ref/hard-mask/genome_modify/chrM.len -f /md01/nieyg/ref/10X/refdata-cellranger-arc-mm10-2020-A-2.0.0/fasta/genome.fa -q 10 -Q 10 atac_possorted_bam_rmdup.realign.bam >  atac_possorted_bam_rmdup.mpileup
